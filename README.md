...
* __predict the level of damage that a house may sustain in the event of an earthquake__.

* __classify the level of damage to a house based on a range of input features__. 
...
### 3.4. Data Preprocessing and Handling Imbalanced Datasets
...
## 4. `Conclusion`
The model can be used to identify houses that are at risk of damage in the event of an earthquake. The results of the project can be a significant step forward in the development of earthquake preparedness and mitigation strategies. 
